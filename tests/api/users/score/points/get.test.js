 ...
 * @author Jade Carino
 */
test.describe('GET request to /api/users/score/points', () => {
  ...
  test('Should get a response from /api/users/score/points', async ({ request }) => {
  ...
  test('Should get a not found response from /api/users/score/points', async ({ request }) => {
