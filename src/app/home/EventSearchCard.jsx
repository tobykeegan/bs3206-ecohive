...
export default function EventSearchCard() {
    return (
        ...
        <Card id='Event-Search-Card' variant='plain' size='lg' sx={{
            width: '100vw',
                ...
                <form
                  style={{
                    ...
                    <FormControl sx={{
                        ...
                        <Row className='justify-content-between' xs={1} md={2} style={{ rowGap: '4px'}}>
                            <Col md={4}>
                        ...
                        <Row className='justify-content-between' xs={1} md={2} style={{ rowGap: '4px'}}>
                            ...
                            <Col md={8}>
                                <Autocomplete 
                                    options={['Demonstration', 'Meet Up', 'Clean Up', 'Education']}
                                    className='search-input'
                                    name='type'
