...
export async function POST(request) {
  ...
  for (let i = 0; i < numEvents; i++) {
    // generate a random creator of this event
    const randomCreator = creators[Math.floor(Math.random() * creators.length)];
    // now generate the event and set some fields
    ...
    // select a random sample of users to attend this event
    ...
    // Add new attendance records for each selected user
